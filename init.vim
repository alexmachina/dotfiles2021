...
" open NerdTree
nnoremap <localleader>nt :NERDTreeTabsToggle<cr>
...
nnoremap <localleader>qa :qall<cr>
...
" File Exploring
nnoremap <localleader>nl :Vex!<cr>
nnoremap <localleader>nk :Hex!<cr>
nnoremap <localleader>nj :Hex<cr>
nnoremap <localleader>nh :Vex<cr>
nnoremap - :Explore<cr>
